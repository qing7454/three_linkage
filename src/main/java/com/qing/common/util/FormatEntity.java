...
import com.qing.common.Constant;
	...
	public static Map<String, String> getObjectValue(Object object) {
		...
		try {
			...
			for (PropertyDescriptor property : propertyDescriptors) {  
				// 如果类型是String
				String v = "";
				if (property.getPropertyType().equals(String.class)) { // 如果type是类类型，则前面包含"class "，后面跟类名
					// 拿到该属性的gettet方法
				...
				// 如果类型是Integer
				if (property.getPropertyType().equals(Integer.class)) {
					Method m = property.getReadMethod();
				...
				// 如果类型是Double
				if (property.getPropertyType().equals(Double.class)) {
					Method m = property.getReadMethod();
				...
				// 如果类型是Short
				if (property.getPropertyType().equals(Short.class)) {
					Method m = property.getReadMethod();
