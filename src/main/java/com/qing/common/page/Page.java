...
public class Page implements Serializable {
	...
	public String toJson() {
		...
		localStringBuffer.append("{'pageNo':").append(this.pageNo).append(",'pageSize':").append(this.pageSize)
				.append(",'start':").append(this.start).append(",'totalCount':").append(this.totalCount)
				.append(",'orderBy':'").append(this.orderBy).append("','orderType':'").append(this.orderType)
				.append("','result':[");
		try {
