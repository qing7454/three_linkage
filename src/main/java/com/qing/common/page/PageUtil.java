...
import com.qing.common.Constants;
import com.qing.common.bean.Entity;
import com.qing.common.util.DateJsonValueProcessor;
import com.qing.common.util.ReflectUtil;
...
public class PageUtil {
	...
	public String toJson(Page page, boolean booleanObject, String columns) {
		...
		config.registerJsonValueProcessor(Timestamp.class, new DateJsonValueProcessor(Constants.DATE_FORMATE));
		config.registerJsonValueProcessor(Date.class, new DateJsonValueProcessor(Constants.DATE_FORMATE));
